...
namespace LINQ.Exercises
{
    ...
    public class Aggregate
    {
        ...
        {
            DateTime result = TestData.People
                .Min(p => p.Born);
        ...
        {
            double result = TestData.People
                .Average(p => p.Born.Year);
        ...
        public void Aggregate_Sum_of_all_numbers()
        {
            ...
            int result = TestData.Numbers
                .Aggregate((sum, nextValue) => sum + nextValue);
        ...
        public void Aggregate_Product_of_all_numbers()
        {
            ...
            int result = TestData.Numbers
                .Aggregate((product, nextValue) => product * nextValue);
        ...
        public void Aggregate_Secret_formula()
        {
            ...
            int result = TestData.People
                .Aggregate(256, (sum, person) =>
                {
                    var day = person.Born.Day;
