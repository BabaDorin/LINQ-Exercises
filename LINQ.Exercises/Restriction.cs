...
namespace LINQ.Exercises
{
    ...
    public class Restriction
    {
        ...
        [TestMethod]
        public void Where_string_ends_with_uppercase_t() // lowecase maybe :)
        {
            IEnumerable<string> result = TestData.Animals
                .Where(a => a.Last() == 't');
        ...
        public void Where_person_firstname_and_lastname_starts_with_same_letter()
        {
            IEnumerable<TestData.Person> result = TestData.People
                .Where(p => p.FirstName[0] == p.LastName[0]);
        ...
        {
            IEnumerable<TestData.Person> result = TestData.People
                .Where(p => p.Born.DayOfWeek == DayOfWeek.Monday && p.Born.Day == 21);
        ...
        {
            var y2000 = new DateTime(2000, 1, 1);

            IEnumerable<TestData.Person> result = TestData.People
                .Where(p => (y2000 - p.Born).TotalDays / 365 >= 18);
        ...
        {
            IEnumerable<TestData.Person> result = TestData.People
                .Where(p => p.LastName.IndexOf("ll") > -1 
