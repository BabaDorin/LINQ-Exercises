...
namespace LINQ.Exercises
{
    ...
    public class Element
    {
        ...
        {
            string result = TestData.Animals
                .Last(a => a == "elephant");
        ...
        {
            // First person in list or the yougest person that was born after 200?
            // This treats the first scenario
            TestData.Person result = TestData.People
                .First(p => p.Born.Year > 2000);
        ...
        {
            TestData.Person result = TestData.People
                .LastOrDefault(p => p.FirstName.First() != 'J');
